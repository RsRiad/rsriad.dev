...
export type AchievementStackItem = {
  id: string | number;
  title: string;
  description?: string;
  imageSrc?: string;
...
export type AchievementStackProps<T extends AchievementStackItem> = {
  items: T[];
...
export function AchievementStack<T extends AchievementStackItem>({
  items,
  initialIndex = 0,
  maxVisible = 7,
              ...
              const dragProps = isActive
                ? {
                    ...
                    onDragEnd: (
                      ...
                      const threshold = Math.min(160, activeCardWidth * 0.22);
                ...
                >
                  ...
                  >
                    {renderCard ? (
                      ...
                      <AchievementCard item={item} active={isActive} />
                    )}
                  </div>
                </motion.div>
              );
...
function AchievementCard({ item }: { item: AchievementStackItem; active: boolean }) {
  return (
